        ...
        return (
            <div>
              ...
              {this.state.redirect &&
                ...
                <Navbar.Brand href="#home">Parcial LAB 4- Tema 1</Navbar.Brand>
                <Navbar.Toggle aria-controls="basic-navbar-nav" />
                <Navbar.Collapse id="basic-navbar-nav">
                  <Nav className="mr-auto">
                    
                     <NavLink to="/redirect/Y" className="mr-2">Home</NavLink>
                     
                    <NavLink to ={'/redirect/All'} className="mr-2">Nuestros Autos</NavLink>
                    <NavLink to ={'/contacto'} className="mr-2">Contacto</NavLink>       
